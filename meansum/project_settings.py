...
from meansum import DATASET_PATH
...
class DatasetConfig(object):
    def __init__(self, name):
        ...
        if name == 'yelp':
            ...
            # Paths
            self.dir_path = DATASET_PATH / 'amazon_dataset/'
            self.processed_path = DATASET_PATH / 'amazon_dataset' / 'processed'
            self.subwordenc_path = DATASET_PATH  / 'amazon_dataset' / 'processed' / 'subwordenc_32000_secondpass.pkl'
